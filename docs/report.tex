...
the minimum energy required to get to each point, based on the minimum energy to
get to the previous points, and the energy at the point. When the matrices were
full, a contour was produced by back-tracking over the position matrix. I
designed my implementation to be as modular as possible to enable easy debugging
and extension.
...
It also meant adding an extra level of looping to the algorithm as all
possibilities of the next point had to be considered as well as the previous
points. This more complex algorithm ensures that straight lines are 
favoured.
