...
\subsection{Optimized Complex Algorithm}
...
optimized version of the complex algorithm.

\subsection{Optimized Complex Algorithm's Logarithms}
...
Seconds (y) for the optimized version of the complex algorithm. This graph shows
